...
function Dashboard(props) {
    ...
    return (
        <div className="container-fluid">
            <Table hover style={{"--bs-table-bg": "inherit", "--bs-table-color": "inherit", "--bs-table-hover-color": "inherit" }}>
                <thead>
                    <tr>
                    ...
                    {!!props.turtles &&
                        Object.keys(props.turtles).map((key) => (
                            <tr key={key} onClick={() => navigate(`/dashboard/${key}`)}>
                                <td>{key}</td>
                                <td>
                                    {props.turtles[key].isOnline ? <GreenText>Online</GreenText> : <GreyText>Offline</GreyText>}
                                </td>
