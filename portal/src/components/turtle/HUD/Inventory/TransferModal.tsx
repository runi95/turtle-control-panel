...
type Props = {
    ...
    hideModal: () => void;
    handleFormSubmit: (e: React.FormEvent<HTMLFormElement>, amount: number) => void;
};

function TransferModal({itemTransfer, isFormValidated, hideModal, handleFormSubmit}: Props) {
